# TNT\Ebay\Sell\Account\V1\LocationApi
...
$apiInstance = new TNT\Ebay\Sell\Account\V1\Api\LocationApi(
...
$inventory_location_full = new \TNT\Ebay\Sell\Account\V1\Model\InventoryLocationFull(); // \TNT\Ebay\Sell\Account\V1\Model\InventoryLocationFull | Inventory Location details
 ...
 **inventory_location_full** | [**\TNT\Ebay\Sell\Account\V1\Model\InventoryLocationFull**](../Model/InventoryLocationFull.md)| Inventory Location details |
...
```php
getInventoryLocation($merchant_location_key): \TNT\Ebay\Sell\Account\V1\Model\InventoryLocationResponse
```
...
[**\TNT\Ebay\Sell\Account\V1\Model\InventoryLocationResponse**](../Model/InventoryLocationResponse.md)
...
```php
getInventoryLocations($limit, $offset): \TNT\Ebay\Sell\Account\V1\Model\LocationResponse
```
...
[**\TNT\Ebay\Sell\Account\V1\Model\LocationResponse**](../Model/LocationResponse.md)
...
$inventory_location = new \TNT\Ebay\Sell\Account\V1\Model\InventoryLocation(); // \TNT\Ebay\Sell\Account\V1\Model\InventoryLocation | The inventory location details to be updated (other than the address and geo co-ordinates).
 ...
 **inventory_location** | [**\TNT\Ebay\Sell\Account\V1\Model\InventoryLocation**](../Model/InventoryLocation.md)| The inventory location details to be updated (other than the address and geo co-ordinates). |
