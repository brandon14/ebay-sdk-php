...
```php
getPayout($payout_id, $x_ebay_c_marketplace_id): \TNT\Ebay\Sell\Finances\V1\Model\Payout
```
...
try {
    $result = $apiInstance->getPayout($payout_id, $x_ebay_c_marketplace_id);
    print_r($result);
} catch (Exception $e) {
...
```php
getPayoutSummary($x_ebay_c_marketplace_id, $filter): \TNT\Ebay\Sell\Finances\V1\Model\PayoutSummaryResponse
```
...
try {
    $result = $apiInstance->getPayoutSummary($x_ebay_c_marketplace_id, $filter);
    print_r($result);
} catch (Exception $e) {
...
```php
getPayouts($x_ebay_c_marketplace_id, $filter, $limit, $offset, $sort): \TNT\Ebay\Sell\Finances\V1\Model\Payouts
```
...
try {
    $result = $apiInstance->getPayouts($x_ebay_c_marketplace_id, $filter, $limit, $offset, $sort);
    print_r($result);
} catch (Exception $e) {
