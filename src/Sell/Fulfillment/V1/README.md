# brandon14/ebay-sell-fulfillment-v1
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/brandon14/ebay-sell-fulfillment-v1.git"
    }
  ],
  "require": {
    "brandon14/ebay-sell-fulfillment-v1": "*@dev"
  }
}
```
...
```php
<?php
require_once('/path/to/brandon14/ebay-sell-fulfillment-v1/vendor/autoload.php');
```
