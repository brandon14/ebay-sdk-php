# trollandtoad/ebay-buy-browse-v1
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/trollandtoad/ebay-buy-browse-v1.git"
    }
  ],
  "require": {
    "trollandtoad/ebay-buy-browse-v1": "*@dev"
  }
}
```
...
```php
<?php
require_once('/path/to/trollandtoad/ebay-buy-browse-v1/vendor/autoload.php');
```
